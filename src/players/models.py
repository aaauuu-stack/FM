...
class MatchRoster:
    ...
    def lineup_pool(self) -> list[PlayerBonus]:
        """
        Giocatori eleggibili per i 4 slot (escluso vice) — solo titolari attesi.

        Quote book calibrano P(gol) ma non sostituiscono SofaScore: in FM chi
        resta in panchina non segna. Portiere: solo titolare con P(CS).
        """
